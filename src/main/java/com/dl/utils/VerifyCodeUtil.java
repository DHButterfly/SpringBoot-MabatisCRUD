 ...
 * ImageIO.write(image, "jpg", response.getOutputStream());// 在HttpServletResponse中有内置方法getOutputStream()，
 * 可以将响应转换成输出流，在通过ImageIO对象的write方法就可以输出到前台页面上去了。
 * 前端获取:<img src="/login/indentycode" />
 */